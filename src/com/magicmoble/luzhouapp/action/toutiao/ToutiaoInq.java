...
public class ToutiaoInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Guanggao> list2 = null;
		int page = 0;
		int fenlei_Tag = 0;
		String my_id=request.getParameter("my_id");
		if (request.getParameter("fenlei_Tag") != null) {
			fenlei_Tag = Integer.parseInt(request.getParameter("fenlei_Tag"));
		}
		...
		try {
			...
			if ( request.getParameter("fenlei_Tag") == null || request.getParameter("page") == null) {
				...
				list = ToutiaoBusiness.getToutiao_ShouyeInfoPage(my_id,page, fenlei_Tag);
