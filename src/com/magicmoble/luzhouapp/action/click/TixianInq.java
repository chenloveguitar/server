...
public class TixianInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String weichat_name = request.getParameter("weichat_name");
		...
		try {
			...
			if (_price == null || weichat_name == null || my_id == null) {
			...
			str=FunctionBusiness.gettixian(my_id, price, weichat_name);
