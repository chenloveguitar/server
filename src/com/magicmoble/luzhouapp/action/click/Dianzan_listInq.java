...
public class Dianzan_listInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (my_id == null || tiaomu_id == null) {
				...
				dianzan_lists = FunctionBusiness.getDianzan_list(tiaomu_id, my_id, page,dianzan_Tag);
				ListObject listObject = new ListObject();
				listObject.setResult(dianzan_lists);
