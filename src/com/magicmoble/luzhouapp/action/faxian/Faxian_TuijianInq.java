...
public class Faxian_TuijianInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("page") == null || request.getParameter("my_id") == null) {
			...
			list = FaxianBusiness.getAllTuijian(my_id, page);
