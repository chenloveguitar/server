...
public class Faxian_clickInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (id == null || my_id == null) {
				...
				FaxianBusiness.faxian_yuedu(id);
				List<Faxian_Xiangqing> list = new ArrayList<Faxian_Xiangqing>();
