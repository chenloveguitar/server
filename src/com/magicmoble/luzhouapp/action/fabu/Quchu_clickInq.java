...
public class Quchu_clickInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (id == null) {
				...
				List<Quchu_Xiangqing> list = new ArrayList<Quchu_Xiangqing>();
				list.add(QuchuBusiness.getQuchuById(id, my_id));
				
				QuchuBusiness.quchu_yuedu(id);
