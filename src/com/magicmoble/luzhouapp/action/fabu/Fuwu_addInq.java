...
public class Fuwu_addInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (title == null || price == null || unit == null || phone == null || picture == null || content == null
					|| my_id == null) {
				...
				FuwuBusiness.addFuwu(my_id, title, price, unit, phone, picture, content);

				DataObject dataObject = new DataObject();
				dataObject.setdata("添加成功");
