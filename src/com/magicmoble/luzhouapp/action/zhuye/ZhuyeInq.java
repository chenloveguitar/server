...
public class ZhuyeInq extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (my_id == null || yonghu_id == null) {
				...
				Zhuye_Model model = ZhuyeBusiness.getZhuye(my_id, yonghu_id);
				if (!(my_id.equals(yonghu_id))) {
					ZhuyeBusiness.add_fangke(my_id, yonghu_id);
				}
				List<Zhuye_Model> list = new ArrayList<Zhuye_Model>();
				list.add(model);
