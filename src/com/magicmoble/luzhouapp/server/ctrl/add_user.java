...
//					System.out.println(_value);
					...
					String filename = new Date().getTime() + "" + (Math.round(Math.random() * 10000)) + "" + ".jpeg";
			...
			map.put("picture", str);
			Server_Func.add_user(map.get("zhanghao"), map.get("user_name"), map.get("password"), map.get("sex"),
					map.get("qianming"), map.get("picture"),map.get("select"));
