...
$(function() {
	...
	$("#page-1").pagination($("#clear-fix-1"),{url:"/mServer/Handle_release_neirong?Tag=1",args:{Tag:1}});
	$("#page-2").pagination($("#clear-fix-2"),{url:"/mServer/Handle_release_neirong?Tag=2",args:{Tag:2}});
	$("#page-3").pagination($("#clear-fix-3"),{url:"/mServer/Handle_release_neirong?Tag=3",args:{Tag:3}});
	$("#page-4").pagination($("#clear-fix-4"),{url:"/mServer/Handle_release_neirong?Tag=4",args:{Tag:4}});
	$("#page-5").pagination($("#clear-fix-5"),{url:"/mServer/Handle_release_neirong?Tag=5",args:{Tag:5}});
	$("#page-6").pagination($("#clear-fix-6"),{url:"/mServer/Handle_release_neirong?Tag=6",args:{Tag:6}});
	$("#page-7").pagination($("#clear-fix-7"),{url:"/mServer/Handle_release_neirong?Tag=7",args:{Tag:7}});
});
...
function getLi(data,Tag) {
	...
	return '<li>' + '<p class="position-show-title">'
			...
			+ data.id
			+ '&Tag='+Tag+'"></a>'
			+ '<a class="icon-edit icon-del" href="/mServer/Handle_release_neirong?del_id='
