...
(function (root, factory) {
    ...
    var defaults = {
        ...
        MARK_DAY_HTML = '<span class="dot"></span>',
        ...
        TEMPLATE = [
            ...
            '<a href="javascript:;" data-calendar-display-date class="calendar-display year-month">',
...
//          '</div>',
			'<div class="calendar-hd">',
			'<span class="prev" data-calendar-arrow-month>{prev}</span>',
			'<a href="javascript:;" data-calendar-display-month class="calendar-display" style="margin-left:20%">{yyyy}</a>',
			 '<span class="next" data-calendar-arrow-month>{next}</span>',
    ...
    Calendar.prototype = {
        ...
        getDisDateValue: function () {
            var arr = this.$disDate.html().split('月').join().split('年'),
                y = Number(arr[0]),
