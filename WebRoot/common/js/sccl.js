	...
	for (var i = 0; i < menu.length; i++) {
		...
		try {
			if (item.isHeader == "1") {
				...
				item.icon == "" ? item.icon = "common/image/icon_manage.png" : item.icon = item.icon;
				if (item.childMenus == "") {
					str = "<li><a href='" + item.url + "'><img src =\"" + item.icon + "\"/><span>" + item.name + "</span></a></li>";
					$(parent).append(str);
				} else {
					str = "<li><a href='" + item.url + "'><img src =\"" + item.icon + "\"/><span>" + item.name + "</span><i class='icon-font icon-right'>&#xe60b;</i></a>";
		...
		"childMenus" : [
			{
				...
				"childMenus" : [
					{
						...
						"parentId" : "2",
						"url" : "",
						"icon" : "common/image/icon_content.png",
						"order" : "1",
						"isHeader" : "0",
						"childMenus" : [ {
							"id" : "301",
							"name" : "待审核",
							"parentId" : "3",
							"url" : "page/Content_management_NoExamine.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
							...
							"name" : "已发布",
							"parentId" : "3",
							"url" : "page/Content_management_Release.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
							...
							"name" : "已下架",
							"parentId" : "3",
							"url" : "page/Content_management_End.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
					...
					},
					{
						...
						"childMenus" : [{
							...
							"name" : "待接单",
							"parentId" : "4",
							"url" : "page/Order_management_NoConfirm.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
							...
							"url" : "page/Order_management_Ongoing.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
							...
							"name" : "已完成",
							"parentId" : "4",
							"url" : "page/Order_management_Completed.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
							...
							"name" : "已取消",
							"parentId" : "4",
							"url" : "page/Order_management_Oncancel.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
							...
							"name" : "有争议",
							"parentId" : "4",
							"url" : "page/Order_management_Controversial.jsp",
							"icon" : "",
							"order" : "1",
							"isHeader" : "0",
							"childMenus" : ""
					...
					},
					{
						...
						"name" : "说说管理",
						"parentId" : "2",
						"url" : "page/Shuoshuo_management.jsp",
						"icon" : "common/image/icon_say.png",
						"order" : "1",
						"isHeader" : "0",
						"childMenus" : ""
					},
					{
						...
						"name" : "评论管理",
						"parentId" : "2",
						"url" : "page/comment.jsp",
						"icon" : "common/image/icon_comment.png",
						"order" : "1",
						"isHeader" : "0",
						"childMenus" : ""
					}, {
						...
						"name" : "用户管理",
						"parentId" : "2",
						"url" : "page/User_management.jsp",
						"icon" : "common/image/icon_user.png",
						"order" : "1",
						"isHeader" : "0",
						"childMenus" : ""
					}, {
						...
						"name" : "广告管理",
						"parentId" : "2",
						"url" : "page/Advertisement_management.jsp",
						"icon" : "common/image/icon_advertisement.png",
						"order" : "1",
						"isHeader" : "0",
						"childMenus" : ""
					}, {
						...
						"parentId" : "2",
						"url" : "page/manage.jsp",
						"icon" : "common/image/icon_picture.png",
						"order" : "1",
						"isHeader" : "0",
						"childMenus" : ""
					},
				...
				"name" : "管理员管理",
				"parentId" : "1",
				"url" : "page/Administrator_management.jsp",
				"icon" : "common/image/icon_administrators.png",
				"order" : "1",
				"isHeader" : "0",
				"childMenus" : ""
			}, {
